        ...
        <div className="hero min-h-screen overflow-hidden pt-24">
            <div className="flex flex-col p-0 lg:flex-row lg:p-16 2xl:max-w-screen-2xl w-screen" style={{gap: '16px',}}>
                ...
                <div className='lg:min-w-1/2 lg:p-0 py-8 px-4 flex flex-col justify-between'>
                    ...
                    <p className='py-4' style={{maxWidth: '440px'}}>I&apos;m a 25-year-old web developer based in the United States. I have big dreams about what the web and its portability and capability offers us. I have extensive experience in vanilla web design, and I am familiar with popular frameworks like React, Next.js, and more.</p>
